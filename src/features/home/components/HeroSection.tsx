  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 text-center">
        {/* Badge */}
        <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-1.5 text-sm backdrop-blur-md mb-8 transition-colors hover:bg-white/10">
          <Sparkles
        ...
        <Fade delay={1000}>
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            {session ? (
              <Button
                size="lg"
                className="h-14 px-10 text-base w-full sm:w-auto bg-white text-zinc-900 hover:bg-zinc-200 active:scale-[0.98] transition-colors duration-200 rounded-full font-bold shadow-[0_0_40px_rgba(255,255,255,0.1)] group"
                asChild
              >
                <Link
                  href="/repo"
              ...
              <>
                <Button
                  size="lg"
                  className="h-14 px-8 text-base w-full sm:w-auto bg-zinc-100 text-zinc-900 hover:bg-white transition-colors duration-200 rounded-full font-semibold shadow-[0_0_40px_rgba(255,255,255,0.1)] group"
                  asChild
                >
                  <Link
                    href="/sign-up"
                ...
                <Button
                  size="lg"
                  variant="outline"
                  className="h-14 px-8 text-base w-full sm:w-auto rounded-full border-white/10 bg-zinc-900/50 backdrop-blur-md hover:bg-zinc-800 transition-colors duration-200 text-zinc-300"
                  asChild
                >
                  <Link
                    href="/sign-in"
        ...
        {/* Trust indicators */}
        <Fade delay={1200}>
          <div className="mt-10 mb-20 flex flex-wrap items-center justify-center gap-x-8 gap-y-4 text-sm font-medium text-zinc-400">
        ...
        <div className="relative z-10 rounded-xl border border-white/10 bg-zinc-950/80 backdrop-blur-2xl overflow-hidden shadow-2xl shadow-black/50 ring-1 ring-white/5">
          ...
          <div className="flex flex-col md:flex-row">
              ...
              <div className="flex gap-4">
                ...
                <div className="flex flex-col gap-1">
                  <div>
                    ...
                    <span className="text-blue-400">validateSession</span>
                    (req: <span className="text-yellow-300">Request</span>)
                    &#123;
                  </div>
                  <div>
            ...
            <div className="w-full md:w-2/5 bg-zinc-900/30 p-6 flex flex-col gap-4">
              ...
              {/* Insight Card 1 */}
              <div className="bg-zinc-900 border border-red-500/20 rounded-lg p-4 shadow-sm relative overflow-hidden hover:border-red-500/40 transition-colors">
