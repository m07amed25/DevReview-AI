    ...
    >
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        {Array.from({ length: 40 }).map((_, i) => (
          <div
            key={i}
            className={`particle absolute rounded-full ${i % 3 === 0 ? "bg-white/30" : "bg-purple-400/20"} blur-[1px] ${
              i % 3 === 0
                ? "w-2 h-2"
                : i % 2 === 0
                  ? "w-4 h-4 shadow-[0_0_15px_rgba(255,255,255,0.2)]"
                  : "w-6 h-6"
            }`}
            style={{
              top: `${(i * 13.51) % 100}%`,
      ...
      <div className="z-10 flex flex-col items-center px-6 md:px-0 text-center max-w-3xl mx-auto">
        ...
        <div
          className="reveal-element relative flex items-center justify-center my-6 group"
          ref={textRef}
        >
          <div className="absolute top-[85%] left-1/2 -translate-x-1/2 w-[60%] h-4 bg-purple-500/50 blur-[20px] rounded-[100%] z-0" />

          <h1
            className="absolute inset-0 z-0 text-transparent font-black text-[12rem] md:text-[20rem] leading-[0.8] tracking-tighter"
        ...
        <p className="reveal-element max-w-xl text-neutral-400 text-lg md:text-xl md:leading-relaxed mb-12">
          ...
          Let&apos;s reroute your navigation coordinates and get you back home
          safely.
        </p>
