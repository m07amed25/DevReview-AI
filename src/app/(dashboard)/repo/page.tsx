...
import { X, RefreshCw, Github, Lock, Globe } from "lucide-react";
...
import { GettingStartedCard } from "@/features/repo/components/getting-started-card";
...
export default function ReposPage() {
  ...
  const openImport = () => { setShowGitHubRepos(true); setSearchQuery(""); setSelectedRepos(new Set()); };
