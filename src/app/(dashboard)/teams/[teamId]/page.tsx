                    ...
                    >
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Button
                          ...
                          onClick={() =>
                            rejectAction.mutate({ actionId: action.id })
                          }
              ...
              {team.data.repositories?.length === 0 && (
                <div className="flex flex-col items-center justify-center py-12 text-center">
                  ...
                  <p className="text-xs text-muted-foreground mt-1 max-w-[200px]">
                    Share a repository to collaborate on code reviews with your
                    team.
                  </p>
                </div>
              )}
        ...
        <AlertDialog open={shareDialogOpen} onOpenChange={setShareDialogOpen}>
          <AlertDialogContent className="sm:max-w-md border-border/60 bg-card/95 backdrop-blur-xl shadow-2xl">
            <AlertDialogHeader>
              ...
              <AlertDialogDescription className="text-muted-foreground/80">
                Select one of your connected repositories to share with this
                team. All team members will be able to view PRs and reviews.
              </AlertDialogDescription>
            </AlertDialogHeader>
              ...
              {sharableRepos.length === 0 && (
                <div className="flex flex-col items-center justify-center py-6">
                  ...
                  <p className="text-xs text-muted-foreground text-center mt-1">
                    You either don&apos;t own any repositories or they are all
                    already shared.
                  </p>
                </div>
              )}
        ...
        >
          <AlertDialogContent className="sm:max-w-md border-border/60 bg-card/95 backdrop-blur-xl shadow-2xl">
            <AlertDialogHeader>
              ...
              <AlertDialogDescription className="text-muted-foreground/80">
                Request an action that requires approval from a team
                administrator.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <div className="space-y-4 py-4 mb-2">
              ...
              <p className="text-xs text-muted-foreground">
                ...
                You&apos;ll be notified when your request is approved or
                rejected.
              </p>
            </div>
            <AlertDialogFooter className="border-t border-border/40 pt-4">
                ...
                onClick={() => {
                  if (selectedActionType) {
                    requestAction.mutate({
                      teamId,
                      actionType: selectedActionType as
                        | "INVITE_MEMBER"
                        | "REMOVE_MEMBER"
                        | "UPDATE_ROLE"
                        | "SHARE_REPOSITORY"
