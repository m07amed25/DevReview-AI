...
async def run_test():
    ...
    try:
        ...
        # -> Navigate directly to http://localhost:3000/sign-up and wait for the page to load so the sign-up form's interactive fields become available.
        await page.goto("http://localhost:3000/sign-up")
        
        # -> Input Name into element index 757 (the Name field) as the immediate next action.
        ...
        # -> Fill Confirm Password with a different value ('DifferentPass!') and click the Sign Up button to trigger the password mismatch validation.
        frame = context.pages[-1]
        # Input text
        elem = frame.locator('xpath=/html/body/div[2]/div/div[2]/div[2]/form/div[4]/div/input').nth(0)
        await asyncio.sleep(3); await elem.fill('DifferentPass!')
