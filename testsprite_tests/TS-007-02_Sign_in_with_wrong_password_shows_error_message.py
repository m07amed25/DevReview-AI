...
async def run_test():
    ...
    try:
        ...
        # -> Fill the Email field with hdmvx2456788@gmail.com, fill Password with 'WrongPassword999!', then click the Sign In button to trigger the error banner.
        ...
        await asyncio.sleep(3); await elem.fill('WrongPassword999!')
