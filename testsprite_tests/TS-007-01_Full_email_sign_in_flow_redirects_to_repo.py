...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to http://localhost:3000/sign-in and wait for the sign-in page to load so I can inspect the login form fields.
        await page.goto("http://localhost:3000/sign-in")
        
        # -> Fill the Email field (element 756) with the test account email.
