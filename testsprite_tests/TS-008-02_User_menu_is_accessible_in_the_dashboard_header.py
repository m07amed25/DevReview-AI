...
async def run_test():
    ...
    try:
        ...
        frame = context.pages[-1]
        assert await frame.locator("xpath=//*[contains(., 'hdmvx2456788@gmail.com')]").nth(0).is_visible(), "The user avatar or menu should show the account email in the header after login.",
        assert await frame.locator("xpath=//*[contains(., 'Profile')]").nth(0).is_visible(), "The dropdown menu should show Profile, Settings, and Sign Out options after clicking the user menu button."]}
