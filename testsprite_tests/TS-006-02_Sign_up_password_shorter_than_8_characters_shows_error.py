...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to http://localhost:3000/sign-up to reach the sign-up form.
        await page.goto("http://localhost:3000/sign-up")
        
        # -> Fill the Name field with 'Test' (input index 783) as the immediate next action.
        ...
        # -> Fill Confirm Password with 'abc' and click Sign Up to trigger and observe the password-length validation error.
        frame = context.pages[-1]
        # Input text
